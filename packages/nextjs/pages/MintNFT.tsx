...
/**
 * Construct and asynchronously initialize a new Objective instance.
 * @returns {Promise<Objective>} a new instance of Objective, ready to mint NFTs.
 */
...
/**
 * Objective is the main object responsible for storing NFT data and interacting with the smart contract.
 ...
 * To make one, use the async {@link MakeObjective} function.
 */
...
class Objective {
     ...
     */
    async createNFTFromAssetData(content:any, options:any) {
     ...
     * @returns {Promise<CreateNFTResult>}
     */
    async createNFTFromAssetFile(filename:string, options:any) {
     ...
     */
    async makeNFTMetadata(assetURI:string, options:any) {
     ...
     */
    async getNFT(tokenId:string, opts:any) {
        ...
        const nft: any = {tokenId, metadata, metadataURI, metadataGatewayURL, ownerAddress}
     ...
     */
    async mintToken(ownerAddress:string, metadataURI:string) {
     ...
     */
    async getCreationInfo(tokenId:string) {
     ...
     */
    async pinTokenData(tokenId:string) {
        const {metadata, metadataURI} = await this.getNFTMetadata(tokenId)
 ...
 */
function extractCID(cidOrURI:string) {
